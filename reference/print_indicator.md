...
**\[superseded\]** Computes and displays an indicator chosen with the
'indicator' argument.
...
- indicator:
  ...
  'ratio', 'gini' and 'atkinson'. If 'ratio' is selected, the user must
  pass a value to the 'ratio' parameter. If 'atkinson', the user mus
  pass a value to 'epsilon'.
